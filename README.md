...
- 종목을 **이름으로 검색**해서 선택 (예: "삼성전자" → 005930 자동 변환). 한국은 KRX 주식과 국내 상장 ETF, 미국은 S&P 500 구성 종목과 미국 상장 ETF가 검색됩니다. 그 밖의 티커는 "코드 직접 추가"로 넣을 수 있습니다. 종목 목록은 `data/cache/_listings/`에 7일간 캐시되며, 검색 범위가 바뀌면 자동 갱신됩니다.
